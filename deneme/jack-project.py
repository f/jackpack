...
class JackProject:
    ...
    def init(self,obj,file_name):
        ...
        if obj == "model":
            self.download = urllib2.urlopen("https://github.com/fkadeveloper/jackpack/raw/master/templates/model.js").read()
            self.download_to = "Model"
        if obj == "controller":
            self.download = urllib2.urlopen("https://github.com/fkadeveloper/jackpack/raw/master/templates/controller.js").read()
        ...
        if obj == "jquery-plugin":
            self.download = urllib2.urlopen("https://github.com/fkadeveloper/jackpack/raw/master/templates/jquery-plugin.js").read()
